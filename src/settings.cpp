...
void Settings::save() const
{
  ...
  settings.setValue(qs_fontColor, fontColor.name(QColor::HexArgb));
  settings.setValue(qs_backgroundColor, backgroundColor.name(QColor::HexArgb));
...
void Settings::load()
{
  ...
  fontColor = QColor(settings.value(qs_fontColor, fontColor.name(QColor::HexArgb)).toString());
  backgroundColor = QColor(settings.value(qs_backgroundColor, backgroundColor.name(QColor::HexArgb)).toString());

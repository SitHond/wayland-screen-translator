...
#if defined(Q_OS_LINUX) && defined(ST_X11_GLOBAL_SHORTCUTS)
#include <X11/Xlib.h>
#include <xcb/xcb.h>
#include <QX11Info>
...
#endif  // ST_X11_GLOBAL_SHORTCUTS

#if defined(Q_OS_LINUX) && !defined(ST_X11_GLOBAL_SHORTCUTS)
namespace service
{
bool GlobalAction::registerHotKey(quint32, quint32)
{
  return false;
}

bool GlobalAction::unregisterHotKey(quint32, quint32)
{
  return true;
}

bool GlobalAction::nativeEventFilter(const QByteArray &, void *, long *)
{
  return false;
}

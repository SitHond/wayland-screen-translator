  ...
  , pageModel_(new QStandardItemModel(this))
{
  ...
  // about
  {
    ...
    const auto aboutLines = QStringList{
        QObject::tr(
            R"(<p>Wayland-native OCR and translation tool</p>)"),
        QObject::tr(R"(<p>Version: %1</p>)")
            .arg(QApplication::applicationVersion()),
        QObject::tr(R"(<p>Maintainer: %1</p>)").arg(maintainer),
        QObject::tr(
            R"(<p>Repository links and update endpoints are intentionally disabled until a new repository is configured.</p>)"),
        QObject::tr(
            R"(<p>Original upstream attribution remains in the license file.</p>)"),
    };
...
void SettingsEditor::pickColor(QWidget *widget)
{
  ...
  const auto color = QColorDialog::getColor(
      original, this, {}, QColorDialog::ShowAlphaChannel);
